  ...
  return (
    <div className="w-full max-w-md space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">Give your AI a photographic memory</p>
      </div>
      ...
      <div className="rounded-lg border bg-card p-6 shadow-sm space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input id="password" type="password" placeholder={"\u2022".repeat(12)} value={password} onChange={(e) => setPassword(e.target.value)} />
        </div>
