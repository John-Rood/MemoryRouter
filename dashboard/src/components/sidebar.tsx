...
import { BarChart3, Key, Settings, CreditCard, BookOpen, Menu, X, LogOut, ChevronDown, Play } from "lucide-react";
...
export function Sidebar({ user, creditBalanceCents }: SidebarProps) {
  ...
  return (
    <>
      {/* Mobile header */}
      <div className="sticky top-0 z-40 flex h-14 items-center gap-x-4 border-b border-border bg-background/80 backdrop-blur-xl px-4 lg:hidden">
