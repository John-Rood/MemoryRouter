...
import { BarChart3, Key, Settings, CreditCard, BookOpen, LogOut, ChevronDown, Play } from "lucide-react";
...
export function Sidebar({ user, creditBalanceCents }: SidebarProps) {
  ...
  return (
    <aside className="hidden lg:flex fixed inset-y-0 left-0 z-40 w-64 flex-col border-r border-border bg-background/95 backdrop-blur-xl lg:static lg:z-auto">
      {/* Logo */}
