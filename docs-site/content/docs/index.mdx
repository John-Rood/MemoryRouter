...
|----------|---------------|--------|
| OpenAI | gpt-4o, gpt-4o-mini, gpt-4.1, gpt-5, o3, o3-mini, o4-mini | `openai/` |
| Anthropic | claude-sonnet-4, claude-sonnet-4.5, claude-opus-4, claude-opus-4.5 | `anthropic/` |
| Google | gemini-2.5-pro, gemini-2.5-flash, gemini-3-pro-preview | `google/` |
...
**90+ models** available out of the box. **OpenRouter** gives you access to 200+ additional models through a single API key.
