...
1. **Recalls** relevant context from past conversations
2. **Enhances** your prompt with what the AI should remember
3. **Forwards** to your chosen AI provider
4. **Remembers** new conversations automatically
5. **Returns** the response — your AI now has memory
